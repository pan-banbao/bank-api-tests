...
class AdminSteps(BaseSteps):
    @allure.step("Создание пользователя {create_user_request}")
    ...
    @allure.step("Удаление пользователя {user_id}")
    ...
    @allure.step("Создание невалидного пользователя {create_user_request}")
    ...
    @allure.step("Авторизация пользователя {login_user_request}")
